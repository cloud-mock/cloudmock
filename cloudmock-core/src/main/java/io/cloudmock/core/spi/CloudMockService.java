 ...
 * implementation class. The core engine calls {@link #register(CloudMockContext)} once on startup
 ...
 * <h2>Threading</h2>
 *
 * <p>{@link #register(CloudMockContext)} is called from a single thread during startup.
...
public interface CloudMockService {
     ...
     * per CloudMock lifecycle, before any test traffic arrives.
     *
