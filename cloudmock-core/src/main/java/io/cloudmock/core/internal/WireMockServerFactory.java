 ...
 *
 * <p>Owns every WireMock-configuration detail — global templating, the CloudMock Handlebars helpers
 * and transformers, the request-journal cap, and port selection — so that CloudMock itself never
...
public final class WireMockServerFactory {
    ...
    public static WireMockServer createStarted(
            CloudMockSettings settings, CloudMockResponseTransformer transformer) {
