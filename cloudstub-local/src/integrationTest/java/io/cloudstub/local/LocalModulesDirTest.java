...
class LocalModulesDirTest {
    ...
    private static Path allModulesDir() {
        String dir = System.getProperty("cloudstub.local.modules.dir");
        assertNotNull(dir, "cloudstub.local.modules.dir system property must be set");
        return Path.of(dir);
    }
    ...
    void sqsServedWhenJarPresent() throws Exception {
        ...
        try (LocalProcess p =
                LocalProcess.startWithModulesDir(PORT_SQS_ONLY, sqsDir, "--services=sqs")) {
            try (SqsClient sqs =
                    SqsClient.builder()
    ...
    void emptyModulesDirStartsWithNoServices() throws Exception {
        ...
        try (LocalProcess p = LocalProcess.startWithModulesDir(PORT_EMPTY, emptyDir)) {
            assertTrue(
    ...
    void servicesFilterAppliesAmongPresentJars() throws Exception {
        ...
        try (LocalProcess p =
                LocalProcess.startWithModulesDir(
