 ...
 * CloudMock starts before the first test, stops after the last, and sets {@code aws.endpoint-url}
 * automatically.
 *
 * <p>Uses only JUnit Jupiter APIs ({@code org.junit.jupiter}), which are stable across JUnit 5 and
 * JUnit 6. {@code cloudmock-junit} declares JUnit as {@code compileOnly}, so the JUnit version on
